		...
		foreach ( $wishlist_items as $item ) :
			...
			if ( $product && $product->exists() ) :
				...
				<tr id="yith-wcwl-row-<?php echo esc_attr( $item->get_product_id() ); ?>" data-row-id="<?php echo esc_attr( $item->get_product_id() ); ?>">
                    ...
                    <td class="wishlist-product-details">
                        ...
                        <div class="product-name">
                            ...
                            <?php if ( $show_remove_product ) : ?>
                                <div class="product-remove">
                                    <div>
                                        <a href="<?php echo esc_url( add_query_arg( 'remove_from_wishlist', $item->get_product_id() ) ); ?>" class="remove remove_from_wishlist" title="<?php echo esc_html( apply_filters( 'yith_wcwl_remove_product_wishlist_message_title', __( 'Remove this product', 'yith-woocommerce-wishlist' ) ) ); ?>"><?php echo esc_html__( 'Remove item', 'halena' ); ?></a>
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
