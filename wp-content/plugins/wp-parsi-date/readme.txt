...
= 2.3.1 =
* Fix date picker's month dropdown bug in admin edit post. [#issue](https://github.com/wordpress-parsi/wp-parsi-date/issues/5)
...
= 2.2.3 =
* Conflict timezone with wordpress default timezone [#issue](https://github.com/wordpress-parsi/wp-parsi-date/issues/1)
