...
/**
 * Makes EDD compatible with wp-parsi-date plugin
 *
...
class WPP_Disable
{
    ...
    public function add_settings($old_settings)
    {
        ...
        $settings = array(
            'dis' => array(
                'id' => 'dis',
                'name' => __('Hook deactivator', 'wp-parsi-date'),
                'type' => 'header'
            ),
            'dis_prices' => array(
                'id' => 'dis_input',
                'name' => __('Hook list', 'wp-parsi-date'),
                'type' => 'textarea',
                'options' => $options,
                'std' => '',
                'desc' => __('Enter hook,class,function to remove parsidate filter from it', 'wp-parsi-date')
            )
        );
