...
class TA_WC_Variation_Swatches_Admin {
	...
	public function includes() {
		include_once( 'class-admin-product.php' );
	}
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_style( 'agni-tawcvs-admin', plugin_dir_url( __FILE__ ) . '../assets/css/admin.css', array( 'wp-color-picker' ), '20160615' );
		wp_enqueue_script( 'agni-tawcvs-admin', plugin_dir_url( __FILE__ ) . '../assets/js/admin.js', array( 'jquery', 'wp-color-picker', 'wp-util' ), '20170113', true );
