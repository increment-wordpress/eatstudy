...
class TA_WC_Variation_Swatches_Frontend {
	...
	public function enqueue_scripts() {
		wp_enqueue_style( 'agni-tawcvs-frontend', plugin_dir_url( __FILE__ ) . '../assets/css/frontend.css' , array(), '20160615' );
		wp_enqueue_script( 'agni-tawcvs-frontend', plugin_dir_url( __FILE__ ) . '../assets/js/frontend.js', array( 'jquery' ), '20160615', true );
	}
